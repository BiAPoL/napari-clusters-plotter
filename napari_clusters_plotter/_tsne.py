...
class TSNEWidget(QWidget):
    ...
    def __init__(self, napari_viewer):
        ...
        # large datasets
        perplexity_container = QWidget()
        perplexity_container.setLayout(QHBoxLayout())
        perplexity_container.layout().addWidget(QLabel("Perplexity"))
        self.perplexity = QSpinBox()
        self.perplexity.setMinimumWidth(40)
        self.perplexity.setMinimum(1)
        self.perplexity.setValue(30)
        perplexity_container.layout().addWidget(self.perplexity)
        ...
        self.layout().addWidget(perplexity_container)
    ...
    def run(self, labels_layer, selected_measurements_list, perplexity ,n_components=2):
        ...
        for i in range(0, n_components):
            properties["tsne_D" + str(i)] = embedding[:,i]
